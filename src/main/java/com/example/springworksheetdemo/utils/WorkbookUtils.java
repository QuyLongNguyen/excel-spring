...
public class WorkbookUtils {
    ...
    public static <T> T getValueAt(Sheet sheet, int rowIndex, int columnIndex, Class<T> classType) {
    ...
    public static <T> T getValueAt(Sheet sheet, Cell cell, Class<T> classType) {
        if (classType.isEnum()) {
